...
<form class="container col-md-6" action="Register" id="myForm" method="get">
	<div class="justify-content-center">
		<div>
			<table class="table">
				<tbody>
					<tr>
						...
						<td><input class="form-control" name="ssnid" type="text"
							required></td>
					</tr>
					<tr>
						<td><label for="patient-name">Patient Name*</label></td>
						<td><input class="form-control" name="patient-name" required
							type="text"></td>
					</tr>
					<tr>
					...
					<tr>
						<td><label for="date-of-admission">Date of Admission*</label>
						</td>
					...
					<tr>
						...
						<td><textarea class="form-control" name="address" required
								type="text" rows="4"></textarea></td>
					<tr>
						<td><label for="state">State*</label></td>
						<td><input class="form-control" name="state" required
							type="text"></td>
					</tr>
					<tr>
						<td><label for="city">City*</label></td>
						<td><input class="form-control" name="city" required
							type="text"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="submit" onclick="myFunction()" class="btn btn-danger" type="button"
							value="Reset"></td>
					</tr>
				</tbody>
			</table>
